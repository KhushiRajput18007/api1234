  ...
  const fetchRandomMeal = async () => {
    try {
      ...
      if (data.meals) {
        ...
        // Add the meal directly to the meals state (or you could handle it separately)
        setMeals([meal]);
      }
    } catch (error) {
  ...
  return (
    <div className="menu-container">
      ...
      <div className="sidebar">
        ...
        {/* New Feature: Search by First Letter */}
      ...
      <div className="main-content">
        ...
        {/* Button to fetch random meal */}
        <div className="random-meal-button">
